...
public class PluginPreferences implements IPreferences {
    ...
    public PluginPreferences() {
        ...
        reportFilePath = new SimpleStringProperty("reportFile.csv");
    ...
    public PluginPreferences(JsonObject data) {
        ...
        if (general != null) {
            setBenchmarkPreferencesFileName(data.getString("benchmarkPreferencesFileName", getBenchmarkPreferencesFileName()));
...
public JsonObject toJson() {
        JsonObject preferences = Json.createObjectBuilder()
            ...
            .add("operationalizations", Json.createObjectBuilder()).build()).build();
